...
function PatientData({
  ...
  return (
    <form className="col-span-3 p-8">
      <div className="grid grid-cols-3 gap-x-8">
        <div className="col-span-3 text-gray-900 text-lg mb-6">
          Rekam Medis Pasien
        ...
        {/* TEMPAT TINGGAL */}
        {/* <div className="col-span-3 text-gray-900 text-lg my-6">
                Tempat Tinggal
                <hr class="h-px bg-gray-700 border-0"></hr>
              </div> */}
