      ...
      /> */}
        ...
        <div className="flex md:order-2 gap-x-4">
          ...
          <Link href="/patient/profile">
            <button
              type="button"
              className="text-blue-700 hover:text-white border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0"
            >
              Informasi Akun
            </button>
          </Link>
