  ...
  return (
    <div>
      <div className="grid grid-cols-5 justify-center min-h-fit max-h-fit w-full min-w-screen mx-auto px-14 pt-24 gap-x-8 gap-y-4 items-center">
        <div className="grid grid-cols-2 col-span-3 items-center h-fit">
          <button
            type="button"
        ...
        <div className="col-span-3 w-full">
          <Link href="#">
            <div className="w-full p-6 bg-white border border-gray-200 rounded-lg shadow">
              ...
              <p className="text-gray-900">Dokter Suryono</p>
            </div>
          </Link>
        </div>
              ...
              <ul role="list" className="divide-y divide-gray-200">
                ...
                <li className="py-3 sm:py-4">
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="inline-flex items-center text-base font-semibold text-gray-900">
                      <span className="hidden inline-flex items-center justify-center w-6 h-6 mr-2 text-sm font-semibold text-white bg-blue-700 rounded-full">
                        <svg
                          className="w-2.5 h-2.5"
                          aria-hidden="true"
                          xmlns="http://www.w3.org/2000/svg"
